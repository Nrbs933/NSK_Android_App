...
public class HighProphetBarimActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        List<Bosses> bossItems = Bosses.find(Bosses.class, "boss_name = ?", "High Prophet Barim");
