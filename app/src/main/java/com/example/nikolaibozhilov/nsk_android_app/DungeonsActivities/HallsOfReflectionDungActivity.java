...
public class HallsOfReflectionDungActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        List<Dungeons> classItems = Dungeons.find(Dungeons.class, "dungeon_name = ?", "Halls of Reflection");
