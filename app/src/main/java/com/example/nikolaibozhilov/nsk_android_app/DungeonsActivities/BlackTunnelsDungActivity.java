...
public class BlackTunnelsDungActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        List<Dungeons> classItems = Dungeons.find(Dungeons.class, "dungeon_name = ?", "The Black Tunnels");
