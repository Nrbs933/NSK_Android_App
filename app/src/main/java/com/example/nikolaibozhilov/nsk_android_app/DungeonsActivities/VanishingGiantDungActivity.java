...
public class VanishingGiantDungActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle("Tombs of the Vanishing Giant");
        ...
        List<Dungeons> classItems = Dungeons.find(Dungeons.class, "dungeon_name = ?", "Tombs of the Vanishing Giant");
